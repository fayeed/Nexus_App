...
public class ReportCustomDialogBox_BHHHOOO extends Dialog implements android.view.View.OnClickListener{
    public Activity c;
    ...
    public BHHHOOO model;
    Spinner spinner;
    GraphEventTrigger graphEventTrigger;
    String role;

    public ReportCustomDialogBox_BHHHOOO(Activity a, String inst, String role, BHHHOOO bhhhooo) {
        super(a);
        this.c = a;
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                AdminReport adminReport = new AdminReport(Profile.getCurrentProfile().getId(),
                        model.getId(),Profile.getCurrentProfile().getName(), model.getName(), editText.getText().toString(), category,
                        false);
